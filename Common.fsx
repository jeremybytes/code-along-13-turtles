...
/// Use a unit of meature to make it clear that angle is in degrees
...
// round a flaot to two places to make it easier to read
...
let calcNewPosition (distance:Distance) (angle:Angle) currentPos =
    // Convert degress to radieans with 180.0 degrees = 1 pi radian
